...
if [ $# != 4 ]
  then
    echo ""
    echo "Usage: loadResearchDataTopDown.sh Host, User, Password, Database"
    echo ""
    exit 1
fi
...
echo "Loading program_2_personnel"
...
echo "Loading mass_spectrometry_result"
$CMD < ../load/mass_spectrometry_result.load
